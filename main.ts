...
function part_1_1 () {
    ...
    story.printCharacterText("Damn where the hell is that old man?", name)
    story.printCharacterText("Now which house does the leader live in? He told me to meet him today.", name)
    story.printCharacterText("Doesn't he live in a bluish-purple house?", name)
    ...
    while (true) {
        ...
        if (sprite_overlapping && Math.abs(sprite_overlapping.bottom - sprite_player.y) < 4) {
            if (sprites.readDataBoolean(sprite_overlapping, "is_house")) {
                ...
                story.printCharacterText("*Knock knock*", name)
                timer.background(function () {
                ...
                if (sprites.readDataBoolean(sprite_overlapping, "has_leader")) {
                    ...
                    story.printCharacterText("Oh yes daddy!", "*Clapping noises*")
                }
                enable_movement(true)
    ...
    pause(1000)
    story.printCharacterText("Ah, hello" + name + "! Come on, we have much to discuss. Follow me.", "Village Leader")
...
function make_villager (picture_index: number, do_wandering: boolean) {
    villager_down_animations = [
    assets.animation`villager_1_walk_down`,
    assets.animation`villager_2_walk_down`,
    assets.animation`villager_3_walk_down`,
    assets.animation`village_leader_walk_down`
    ]
    villager_up_animations = [
    assets.animation`villager_1_walk_up`,
    assets.animation`villager_2_walk_up`,
    assets.animation`villager_3_walk_up`,
    assets.animation`villager_leader_walk_up`
    ]
    villager_right_animations = [
    assets.animation`villager_1_walk_right`,
    assets.animation`villager_2_walk_right`,
    assets.animation`villager_3_walk_right`,
    assets.animation`villager_leader_walk_right`
    ]
    villager_left_animations = [
    assets.animation`villager_1_walk_left`,
    assets.animation`villager_2_walk_left`,
    assets.animation`villager_3_walk_left`,
    assets.animation`village_leader_walk_left`
    ]
...
function part_2_1 () {
    ...
    fade_out(true)
    story.printCharacterText("Now where the hell did that thing go?", name)
    story.printCharacterText("Bruh. I see you right there.", name)
    enable_movement(true)
    character.clearCharacterState(sprite_player)
    can_fight = true
    can_slow_time = true
    ...
    can_slow_time = false
    character.setCharacterState(sprite_player, character.rule(Predicate.FacingLeft, Predicate.NotMoving))
    story.printCharacterText("Wow, this place is HUGE! (Thats what I said)", name)
    character.clearCharacterState(sprite_player)
...
function part_1_2 () {
    ...
    color.pauseUntilFadeDone()
    can_skip_dialog = true
    story.printCharacterText("" + name + ", I have been wanting to tell you this for a VERY VERY long time but I'm too much of a pussy to tell you", "Village Leader")
    story.printCharacterText("You have the ability to control time.", "Village Leader")
    story.printCharacterText("Yeah I know dumbfuck.", name)
    story.printCharacterText("No. I am serious. You can control time.", "Village Leader")
    story.printCharacterText("Alright not really control as you (and I) can only slow it down. ", "Village Leader")
    story.printCharacterText("Wait, you have that shit too?", name)
    story.printCharacterText("Yeah? Did you not see? ", "Village Leader")
    story.printCharacterText("Wouldn't other people have noticed?", name)
    story.printCharacterText("You are such a fucking idiot, do they have secret ass powers to control time? No dumbass.", "Village Leader")
    story.printCharacterText("But people who can slow down time, like you - they can notice it", "Village Leader")
    story.printCharacterText("Believe it or not, I was actually young one time. Before I could slow down time and only require a 3 hour nap after. But now, I'm too old to do this st-", "Village Leader")
    story.printCharacterText("Shut the fuck up I get it.", name)
    story.printCharacterText("Alright, alright.", "Village Leader")
    story.printCharacterText("I told you this because the Serpents on the other side of the river-", "Village Leader")
    story.printCharacterText("Serpents?", name)
    ...
    music.setVolume(20)
    story.printCharacterText("ARE YOU FUCKING KIDDING ME? ", "Village Leader")
    story.printCharacterText("Guess you didn't need to tell me the shit huh?", name)
    story.printCharacterText("Alight anyway, go fuck with those snakes being the zoophile you are. Bye.", "Village Leader")
...
function save_part (part: string) {
    ...
    timer.after(4000, function () {
        timer.background(function () {
            Notification.waitForNotificationFinish()
            Notification.notify("Progress saved, you may now exit or continue", 1, assets.image`floppy_disc`)
        })
    })
}
...
function part_2_3 () {
    ...
    pause(1000)
    story.printCharacterText("Hello there " + name + ", I've been waiting for you...", "Snake Pedophile ")
    story.printCharacterText("Eugh, get your fetish away from me", name)
    story.printCharacterText("Will you atleast let me vore you? Anyway, I'm a spooky bad monster and you have to fight me. ", "Snake Pedophile ")
    story.printCharacterText("I've gotten maybe at least 90% of the world. What are the exact numbers again?", "Snake Pedophile ")
    story.printCharacterText("97.89%!", "*Voice in the distance*")
    story.printCharacterText("Shut the fuck up, but yeah thats how much of the world I've taken over with my Rule 34.", "Snake Pedophile ")
    story.printCharacterText("Anyways, I just need you out of the way.", "Snake Pedophile ")
    story.printCharacterText("But what if I fuck you up right here?", name)
    story.printCharacterText("Bro I'm literally going to fuck your ass and choke you with my dick-tail.", "Snake Pedophile ")
    story.printCharacterText("Whaaat?", name)
    story.printCharacterText("Don't worry about it. ", "The Snake Emperor")
    story.printCharacterText("Anyway, considering the spooky monster I am, I won't fuck you up too hard.", "Snake Pedophile ")
    story.printCharacterText("And then I will give you some of my famous White Milk.", "The Snake Emperor")
    story.printCharacterText("Anyways let me just quickly shoot some of it into your face and after I will see my fucktoy.", "Snake Pedophile ")
    story.printCharacterText("They are all dead!", "*Voice in the distance*")
    story.printCharacterText("GOD FUCKING DAMN IT. I WANTED TO TEST DOGGY STYLE", "Snake Pedophile ")
    ...
    slowing_time = false
    pause(1000)
    story.printCharacterText("Man can you atleast let me shoot some of this?", "Snake Pedophile ")
    story.printCharacterText("No you fucking pedohpile.", name)
    story.printCharacterText("I NEED TO FIND NEW FUCKTOYS PLEASE", "Snake Pedophile ")
    ...
    story.printCharacterText("Also I'm not affected by your time shit.", "Snake Pedophile ")
    story.printCharacterText("My White Milk is though.", "Snake Pedophile ")
    enable_movement(true)
    can_fight = true
    can_slow_time = true
    energy_level = 100
    ...
    can_slow_time = false
    timer.background(function () {
        story.printCharacterText("DAMN IT I JUST WANTED TO FUCK KIIIIIIIIDDDDDSSSS", "Snake Pedophile ")
    })
    fade_in(true)
    story.clearAllText()
}
...
function part_1_3 () {
    ...
    story.printCharacterText("What the fuck are those slimy shits?", name)
    pause(1000)
    ...
    pause(1000)
    timer.background(function () {
        story.printCharacterText("Come back! I see you over there dumbass.", name)
    })
